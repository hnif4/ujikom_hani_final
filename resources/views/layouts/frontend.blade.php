...
<body class="bg-gray-50">
    ...
    <div class="glass-effect border-b border-primary-200/20">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <!-- Mobile Menu Button -->
                <button id="mobileMenuButton" class="md:hidden text-primary-700">
    ...
    <!-- Mobile Navigation -->
    <div id="mobileMenu" class="hidden md:hidden flex-col mt-2 space-y-2 bg-white p-4 shadow-lg">
        <a href="/" class="block text-primary-700 hover:text-primary-800 font-medium transition duration-300">Beranda</a>
        <a href="/gallery" class="block text-primary-700 hover:text-primary-800 font-medium transition duration-300">Galeri</a>
        <a href="/informasi" class="block text-primary-700 hover:text-primary-800 font-medium transition duration-300">Informasi</a>
        <a href="/agenda" class="block text-primary-700 hover:text-primary-800 font-medium transition duration-300">Agenda</a>
        <a href="#maps" class="block text-primary-700 hover:text-primary-800 font-medium transition duration-300">Kontak</a>
        <a href="{{ auth()->check() ? url('/admin/dashboard') : route('login') }}"
            class="block px-4 py-2 rounded-lg bg-primary-600 text-white hover:bg-primary-700 transition duration-300 shadow-sm">
            {{ auth()->check() ? 'Dashboard' : 'Login' }}
        </a>
    </div>
</nav>
